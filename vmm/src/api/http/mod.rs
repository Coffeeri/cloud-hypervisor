...
use crate::api::{
    ...
    VmDelete, VmDiskMirrorPivot, VmDiskMirrorStart, VmDiskMirrorState, VmMigrationProgress, VmNmi,
...
pub static HTTP_ROUTES: LazyLock<HttpRoutes> = LazyLock::new(|| {
    ...
    r.routes.insert(
        endpoint!("/vm.disk-mirror-pivot"),
        Box::new(VmActionHandler::new(&VmDiskMirrorPivot)),
    );
