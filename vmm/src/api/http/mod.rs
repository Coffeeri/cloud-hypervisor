...
use crate::api::{
    ...
    VmDelete, VmDiskMirrorStart, VmDiskMirrorStatus, VmMigrationProgress, VmNmi, VmPause,
    VmPostMigrationAnnounce, VmPowerButton, VmReboot, VmReceiveMigration, VmRemoveDevice, VmResize,
...
pub static HTTP_ROUTES: LazyLock<HttpRoutes> = LazyLock::new(|| {
    ...
    r.routes.insert(
        endpoint!("/vm.disk-mirror-status"),
        Box::new(VmActionHandler::new(&VmDiskMirrorStatus)),
    );
