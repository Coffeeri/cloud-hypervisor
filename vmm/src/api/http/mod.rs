...
use crate::api::{
    ...
    VmDelete, VmDiskMirrorStart, VmDiskMirrorState, VmMigrationProgress, VmNmi, VmPause,
...
pub static HTTP_ROUTES: LazyLock<HttpRoutes> = LazyLock::new(|| {
    ...
    r.routes.insert(
        endpoint!("/vm.disk-mirror-state"),
        Box::new(VmActionHandler::new(&VmDiskMirrorState)),
    );
